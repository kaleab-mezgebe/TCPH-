...
class Addnewdatacollector extends StatefulWidget {
  final String? username;
  const Addnewdatacollector({super.key, required this.username});
  @override
  _AddnewdatacollectorState createState() => _AddnewdatacollectorState();
}

class _AddnewdatacollectorState extends State<Addnewdatacollector> {
  ...
  Future<void> _registerUser() async {
    ...
    const url =
        'https://repositoryformymobapp-kaleab-mezgebe.onrender.com/addnewDataCollector'; // Replace with your API endpoint
    try {
      final dio = Dio();
      ...
      formData.fields
        ...
        ..add(MapEntry('createdBy', widget.username ?? ''));
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('መፍለዪ ሽም ተታሒዙ! በይዘኦም ካሊእ የእትው'),
        ),
      );
    }
  }
