...
import 'MessageToDataCollectorMov.dart';
import 'MessageFromDataCollectorMov.dart';
...
class _ViewEachDataCollectorState extends State<ViewEachDataCollectorDatas> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ተንቐሳቐስቲ ሓድግታት'),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Align(
                                // Align Text within the button to the left
                            ...
                            TextButton(
                              onPressed: () async {
                                ...
                                final response = await http.put(
                                  Uri.parse(
                                      'https://repositoryformymobapp-kaleab-mezgebe.onrender.com/update-seen-data-collector/$id'),
                                  headers: {
