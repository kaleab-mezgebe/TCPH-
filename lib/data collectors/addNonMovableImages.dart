...
class AddImages extends StatefulWidget {
  ...
  final int id;
  const AddImages({super.key, required this.id});

  @override
  _RegistrationFormState createState() => _RegistrationFormState();
}

class _RegistrationFormState extends State<AddImages> {
  ...
  Future<void> _registerUser() async {
    ...
    final url =
        'https://repositoryformymobapp-kaleab-mezgebe.onrender.com/nonMovupdateImage/?id=${widget.id}'; // Replace with your API endpoint
    try {
      final dio = Dio();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('መስፈሪ ስእልታት ሓድጊ'),
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                const Text('\nስእሊታት ናይቲ ሓድጊ ካሜራ ብምልዓል ወይ ድማ ካብ ፋይል ብምምራፅ ኣስፍሩ'),
                ElevatedButton(
