...
import 'addNonMovableImages.dart'; // Import the updateimages.dart file
...
class _ImageGalleryPageState extends State<ImageGalleryPage> {
  ...
  Future<void> fetchImagePaths() async {
    ...
    final response = await http.get(Uri.parse(
        'https://repositoryformymobapp-kaleab-mezgebe.onrender.com/api/nonMovimages?id=${widget.id}'));
  ...
  Future<void> deleteImage(String filename) async {
    final response = await http.delete(
      Uri.parse(
          'https://repositoryformymobapp-kaleab-mezgebe.onrender.com/api/nonMovimages/$filename?id=${widget.id}'),
    );
    if (response.statusCode == 200) {
      setState(() {
