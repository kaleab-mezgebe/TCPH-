...
class AddDescriptiveImage extends StatefulWidget {
  // const AddDescriptiveImage({super.key});
  final int id;
...
class _RegistrationFormState extends State<AddDescriptiveImage> {
  ...
  Future<void> _registerUser() async {
    ...
    final url =
        'https://repositoryformymobapp-kaleab-mezgebe.onrender.com/updateImageMovSignature/?id=${widget.id}'; // Replace with your API endpoint
    try {
      final dio = Dio();
